...
-- Arquivo 02: Stored procedure para carga de dados simulados
...
BEGIN
    FOR i IN 1..1000 LOOP
        ...
        ELSE
            ...
            taxa_conversao_random := CASE 
                WHEN RANDOM() < 0.5 THEN NULL 
                ELSE ROUND((RANDOM() * 10)::NUMERIC, 6) 
            END;
        END IF;
...
-- Executa a procedure para carregar os dados
CALL cap13.carregar_dados_contabeis();

-- Verifica os primeiros registros carregados
SELECT *
